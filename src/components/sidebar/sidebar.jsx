function Sidebar() {
  ...
  return (
    <div className="group/sidebar h-screen sticky top-0 bg-blue-600 shadow-md transition-all duration-300 ease-in-out w-16 hover:w-64 overflow-hidden flex flex-col justify-between">
      {/* Top links */}
