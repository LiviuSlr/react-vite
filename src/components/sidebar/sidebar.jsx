function Sidebar() {
  ...
  return (
    <div className="group/sidebar h-full bg-blue-600 shadow-md transition-all duration-300 ease-in-out w-16 hover:w-64 overflow-hidden">
      <div className="flex flex-col h-full items-start py-4 space-y-2 px-2">
        {items.map((item) => (
          <a
